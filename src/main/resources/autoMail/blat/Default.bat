...
:::::192.168.0.1::::
echo  ------------Default------------->>%3%1_TracetResut.txt
netsh interface ip set dns "Local" static %2
tracert littlegym.wmod.llnwd.net>>%3%1_TracetResut.txt
tracert lessonplans.thelittlegym.com>>%3%1_TracetResut.txt
tracert training.thelittlegym.com>>%3%1_TracetResut.txt
